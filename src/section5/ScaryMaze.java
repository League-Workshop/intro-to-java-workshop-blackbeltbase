...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	if(mouseColor == -16738680 )
	{
		JOptionPane.showMessageDialog(null, "Congragualtions! You Won!");
	}
	...
	private void scare() {
		...
		showScaryImage("scaryPicture.png");
	}
