...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
														// health reaches 0
			String attackStrategy = JOptionPane.showInputDialog("Do you want to attack with a yell or a kick?");
			if (attackStrategy.equalsIgnoreCase("yell")) {
				dragonDamage = new Random().nextInt(10);
				dragonHealth -= dragonDamage;
				if (dragonHealth <= 0) {
					JOptionPane.showMessageDialog(null,
							"You defeated the dragon and obtained large sums of gold! You are the superior dragon hunter!");
				} else {
					JOptionPane.showMessageDialog(null, "Dragon Health: " + dragonHealth);
				}
			} else if (attackStrategy.equalsIgnoreCase("kick")) {
